...
class FeedForward(BASE_ESTIMATOR):
    ...
    def fit(self, X, y=None, eval_data=None, eval_metric='acc', val_eval_metric='acc',
            epoch_end_callback=None, batch_end_callback=None, kvstore='local', logger=None,
            work_load_list=None, monitor=None, eval_batch_end_callback=None, hostname=None, 
            dataset=None, staleness=None, network_name=None, lr=None): #yegeyan 2016.10.6
        """Fit the model.
